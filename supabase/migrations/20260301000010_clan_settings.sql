...
CREATE TABLE IF NOT EXISTS clan_settings (
  ...
  clan_name        VARCHAR(200) NOT NULL DEFAULT 'Họ Lê Sỹ',
  clan_full_name   VARCHAR(500) NOT NULL DEFAULT 'Họ Lê Sỹ xã Thường Xuân, tỉnh Thanh Hóa',
...
INSERT INTO clan_settings (id, clan_name, clan_full_name)
  VALUES ('a3318c78-6938-4d5d-a183-64ce899241e1', 'Họ Lê Sỹ', 'Họ Lê Sỹ xã Thường Xuân, tỉnh Thanh Hóa')
