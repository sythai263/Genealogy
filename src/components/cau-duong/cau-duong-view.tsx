        ...
        <Card className="border-primary/20 bg-primary/5">
          <CardContent className="py-3 px-4 flex flex-col sm:flex-row sm:items-center gap-2 text-sm">
            ...
            <span className="text-muted-foreground">
              Đời {firstPool.min_generation} trở xuống • Dưới{' '}
              {firstPool.max_age_lunar} tuổi âm • Nam giới đã lập gia đình
            </span>
          </CardContent>
        </Card>
      )}
        ...
        <TabsContent value="members" className="mt-4">
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Thứ tự theo cây gia phả (DFS preorder) — đời trên trước, trong mỗi
                đời theo thứ tự gia đình
              </CardDescription>
            </CardHeader>
            <CardContent>
              {eligibleLoading ? (
                  ...
                  {eligibleMembers.map((member, idx) => (
                    ...
                    >
                      ...
                      <div className="text-right text-xs text-muted-foreground">
                        {member.ageLunar > 0 && (
                          <span>{member.ageLunar} tuổi âm</span>
                        )}
